...
var Author = mongoose.model('Author',NewBookSchema);  // creation of model and stored it into a variable inorder to acessing it to diffrent files for creating instance thereby adding the documents in to the collection

module.exports = Author // export the model in to other files for creating instances to store the documents.
